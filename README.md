...
Developed by [Apo](https://github.com/apolololo), this extension is user-friendly and provides all the information you need.
...
1. **Download the extension**:
   ...
   - Or download the latest release from the [releases page](https://github.com/apolololo/EpicFree/releases) and extract it
...
### 🔄 How It Works
1. When you open the extension, it immediately displays current and upcoming free games
2. Data is retrieved from the Epic Games API and cached locally
3. For each game, you can see:
   - The game title
...
4. Click on the "View on Epic Games Store" button to open the official website
...
This extension is distributed under a custom license. See the [LICENSE.md](LICENSE.md) file for more details.
...
[![Ko-fi](https://storage.ko-fi.com/cdn/kofi1.png?v=6)](https://ko-fi.com/apo__)
...
Développée par [Apo](https://github.com/apolololo), cette extension est simple d'utilisation et fournit toutes les informations dont vous avez besoin.
...
1. **Téléchargez l'extension** :
   ...
   - Ou téléchargez la dernière version depuis la [page des releases](https://github.com/apolololo/EpicFree/releases) et extrayez-la
...
### 🔄 Fonctionnement
1. Lorsque vous ouvrez l'extension, elle affiche immédiatement les jeux gratuits actuels et à venir
2. Les données sont récupérées depuis l'API d'Epic Games et mises en cache localement
3. Pour chaque jeu, vous pouvez voir :
   - Le titre du jeu
...
4. Cliquez sur le bouton "Voir sur Epic Games Store" pour ouvrir le site officiel
...
Cette extension est distribuée sous une licence personnalisée. Voir le fichier [LICENSE.md](LICENSE.md) pour plus de détails.
